   ...
   <View style={ Style.container}>
     {/* Header */}
       <Header style={{ height: 70 }} 
            ...
            ></Header>
                       <Text style={Style.title}>الأخبار</Text>
                       {/* Search bar */}
                       <View style={[Style.SearchContainer,{flexDirection: 'row-reverse' }]}>
              <InputText value={SearchText} HandleChange={(e) => onChangeText(e)} style={Style.inputStyle} inputType="TextInput"  placeholder={'بحث...'}/>
              <IconButton icon='magnify' color={Colors.secondary} size={25} style={Style.iconStyle} />
